...
const div_search_filter=document.createElement("div");
...
const search_filter=document.createElement("input");
...
const display_breweries_details= (breweries) =>{
